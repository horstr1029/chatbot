...
export type Intent = 'DOC_QUESTION' | 'WORKFLOW_REQUEST' | 'FORM_REQUEST' | 'REMINDER_REQUEST' | 'CROSS_DEPT_REQUEST' | 'GENERAL_CHAT'

const VALID_INTENTS = new Set<Intent>(['DOC_QUESTION', 'WORKFLOW_REQUEST', 'FORM_REQUEST', 'REMINDER_REQUEST', 'CROSS_DEPT_REQUEST', 'GENERAL_CHAT'])

const PROMPT = (message: string) =>
  `Classify the user message below into exactly one of: DOC_QUESTION, WORKFLOW_REQUEST, FORM_REQUEST, REMINDER_REQUEST, CROSS_DEPT_REQUEST, GENERAL_CHAT.
